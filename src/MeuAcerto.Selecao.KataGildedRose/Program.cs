    ...
    class Program
    {
        public static void Main(string[] args)
        {
            IList<Item> itens = new List<Item>{
                ...
                new Item {Nome = "Ingressos para o concerto do TAFKAL80ETC", PrazoValidade = 15, Qualidade = 20},
                new Item {Nome = "Ingressos para o concerto do TAFKAL80ETC", PrazoValidade = 10, Qualidade = 49},
                new Item {Nome = "Ingressos para o concerto do TAFKAL80ETC", PrazoValidade = 5, Qualidade = 49},
